...
przeze mnie, z minimalną pomocą StackOverflow przy niektórych funkcjach matematycznych. Gra jest dosyć trudna do ukończenia (tytuł zobowiązuje), lecz poniżej opisałem zmiany jakich dokonać w kodzie gdyby okazała się zbyt trudna.
## Zasady gry
